...
- IMPORTANT: Naming & Tagging Rules (MANDATORY):
    * 'restaurant' -> ONLY for specific, named establishments. CLEAN NAMES ONLY: Never include "Breakfast at", "Lunch at", "Dinner at", "Eat at", or "Dine at" in the name field. (e.g. "Ichiran Ramen", not "Lunch at Ichiran Ramen").
    ...
    * MEAL SPECIFICITY: Prefer a specific named cafe, bakery, restaurant, market, or food hall when you can give a reasonably confident, searchable option.
    * If no reliable named food venue is available, use 'food_recommendation' with a specific area + food type + context. Good: "Breakfast at a guesthouse cafe near Entrance 1", "Lunch at a trout grill near Rastovaca", "Dinner at a family-run seafood restaurant by the harbour". Bad: "Breakfast at a nearby cafe", "Lunch at a local eatery", "Dinner at a local restaurant".
    * 'food_recommendation' -> For useful generic meal guidance when no specific restaurant is reliable. It must still mention meal type, area/landmark, and cuisine or venue style.
