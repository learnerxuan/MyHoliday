...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      name: 'search_places',
      description: 'Search Google Maps for specific places, restaurants, hotels, or attractions. Call this when the user asks for recommendations, ideas, or to find specific spots.',
      parameters: {
        type: 'object',
        properties: {
